...
public class Appender extends AppenderBase<ILoggingEvent> {
     ...
     */
    private static final SimpleAttributeSet ERROR_ATT, WARN_ATT, INFO_ATT, DEBUG_ATT;
     ...
     */
    private int getLineCount(JTextArea textPane) {
     ...
     * getLineCount)
     */
    private int getLineEndOffset(JTextArea textPane, int line) throws BadLocationException {
     ...
     */
    private void replaceRange(JTextArea textPane, String str, int start, int end) throws IllegalArgumentException {
        if (end < start) {
